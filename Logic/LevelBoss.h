...
class Level_Boss
{
	...
	friend void CountDemageBetweenPlayerAndBoss(SetOfBullets &SetOfB, Level_Boss &BOSS, player_object &P1);  // Проверяет попадание пль игрока в босса и наоброт и если попадание есть отнимает здоровье
	void DeleteBullets();
public:
